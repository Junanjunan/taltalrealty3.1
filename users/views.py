...
def github_login(request):
    if settings.DEBUG == True:
        ...
        redirect_uri = "http://taltalrealty3-dev.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback/"
...
def kakao_login(request):
    if settings.DEBUG == True:
        ...
        REDIRECT_URI = "http://taltalrealty3-dev.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback/"
...
def naver_login(request):
    if settings.DEBUG == True:
        ...
        redirect_uri = "http://taltalrealty3-dev.ap-northeast-2.elasticbeanstalk.com/users/login/naver/callback/"
